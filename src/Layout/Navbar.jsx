...
const Navbar = () => {
  ...
  return (
    <header>
        <nav className={`flex justify-between items-center md:px-10 lg:px-16 text-white fixed transition-all duration-500 ${navbarVisible ?'backdrop-blur-md bg-black/40':''} w-full z-50`}>
            <div className='py-4'>
